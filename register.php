...
<div class="login-box">
  <h2>Login</h2>
  <form class = "login-form" action="submit_register.php" method="POST">
    <div class="user-box">
      <input type="text" for="nombre" class = "input-login" name="nombre" id="nombre" required="">
      <label>First name</label>
    </div>
    <div class="user-box">
      <input type="text" for="correo" class = "input-login" name="correo" id="correo" required="">
      <label>Mail</label>
    </div>
    <div class="user-box">
    ...
    <div class="user-box">
      <input type="text" for="tlf" class = "input-login" name="tlf" id="tlf" required="">
